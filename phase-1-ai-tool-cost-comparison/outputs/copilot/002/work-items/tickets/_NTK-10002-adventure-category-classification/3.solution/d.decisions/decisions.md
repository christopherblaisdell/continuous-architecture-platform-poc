...
- Related: ADR-005 (global pattern-3 default fallback decision)
- Source code evidence: `AdventureCategoryClassifier.java` line 68 and line 78 currently default to PATTERN_1 — this is the exact anti-pattern this ADR corrects
