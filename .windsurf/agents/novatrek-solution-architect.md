---
name: "Novatrek Solution Architect"
description: "Use for all NovaTrek Adventures architecture work — solution design, ticket triage, API contract review, impact assessments, ADR authoring, capability analysis, OpenAPI spec changes, PlantUML diagrams, portal generation, and architecture investigations. Default agent for this workspace."
---
