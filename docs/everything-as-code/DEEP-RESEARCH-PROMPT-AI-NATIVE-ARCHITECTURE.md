...
**Usage**: This is a deep research prompt suitable for an AI deep-research session. The expected output should be pasted into [Deep Research Response — AI-Native Architecture](DEEP-RESEARCH-PROMPT-AI-NATIVE-ARCHITECTURE-RESPONSE.md).
