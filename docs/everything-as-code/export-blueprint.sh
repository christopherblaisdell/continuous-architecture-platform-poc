...
echo ""
echo "  1. cd $DEST"
echo "  2. Update the Blueprint Version table in README.md:"
echo "        Record the imported version (2026.05), today's import date, and your Instance name."
echo "        This lets you track when to pull a newer version of the blueprint."
echo "  3. Open TRANSFORMATION-PLAN.md — complete the Bootstrap section:"
echo "        a. Run the pillar selection exercise (mark each of the 34 pillars In Scope / Out of Scope / Future)"
echo "        b. Identify the pilot pillar"
echo "  4. Replace CURRENT-STATE-ASSESSMENT.md with a real assessment of your workspace"
echo "     (keep the structure; replace all NovaTrek findings with your actual findings)"
echo "  5. Author the adoption ADR in your decisions/ folder"
echo "     (use the MADR template; declare which pillars are in scope for Wave 1)"
echo "  6. Commit docs/everything-as-code/ to version control"
echo "  7. Add the EaC track to your roadmap"
echo ""
