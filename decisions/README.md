...
| [ADR-006](ADR-006-orchestrator-pattern-checkin.md) | Orchestrator Pattern in svc-check-in | Accepted | 2026-01-29 | svc-check-in, svc-reservations, svc-guest-profiles, svc-safety-compliance, svc-gear-inventory | NTK-10003 |
| [ADR-007](ADR-007-four-field-identity-verification.md) | Four-Field Identity Verification | Accepted | 2026-01-29 | svc-check-in, svc-reservations | NTK-10003 |
| [ADR-008](ADR-008-temporary-guest-profile.md) | Temporary Guest Profile Creation | Accepted | 2026-01-30 | svc-guest-profiles, svc-check-in | NTK-10003 |
