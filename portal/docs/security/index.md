...
| [Implementation Plan](implementation-plan.md) | Four-sprint plan to implement the documented controls as live, working demonstrations with a 15-minute demo script |
