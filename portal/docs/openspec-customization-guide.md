...
For how GitHub Copilot's native customization system works, see [GitHub Copilot Customization Guide](github-copilot-customization-guide.md). For a side-by-side comparison and recommendation, see [Copilot vs OpenSpec Comparison](copilot-vs-openspec-comparison.md).
...
For detailed enforcement comparison, see [Copilot vs OpenSpec Comparison](copilot-vs-openspec-comparison.md).
