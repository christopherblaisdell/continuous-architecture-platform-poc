...
| Event flows (Kafka) | 58 |
| Database connections | 23 |
| Total nodes | 78 |
| Total relationships | 153 |
...
| Page | Description |
|------|-------------|
| [System Map](system-map.md) | Interactive Mermaid diagram showing all 23 services grouped by domain with REST and event-driven connections |
