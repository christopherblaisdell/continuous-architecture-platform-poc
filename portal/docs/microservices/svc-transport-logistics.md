...
<span class="diagram-source-subtitle">Source: <a href="https://github.com/christopherblaisdell/continuous-architecture-platform-poc/blob/main/architecture/diagrams/endpoints/svc-transport-logistics--post-transport-requests.puml"><code>architecture/diagrams/endpoints/svc-transport-logistics--post-transport-requests.puml</code></a></span>
