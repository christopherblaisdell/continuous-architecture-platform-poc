...
Run a structured security review on a NovaTrek solution design using OWASP Top 10, Spring Boot patterns, and NovaTrek data ownership rules. Produces a severity-rated findings report.
