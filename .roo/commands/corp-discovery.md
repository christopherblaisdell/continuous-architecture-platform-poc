...
Corporate workspace discovery — audit the actual state of architecture practice to replace synthetic assumptions in the OpenSpec greenfield/brownfield analysis
