...
Run a structured investigation of a NovaTrek architecture ticket using mock tools in the correct sequence: JIRA first, then Elastic logs, then GitLab MRs. Produces an evidence-based investigation report.
