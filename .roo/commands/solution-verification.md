...
Verify a NovaTrek solution design for completeness, consistency, and quality before merge. Checks all required sections, capability rollup, content separation, metadata consistency, and cross-references.
