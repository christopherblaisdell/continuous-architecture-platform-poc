...
Run a structured architecture review of a NovaTrek service, solution design, or proposed change. Analyzes current state, evaluates trade-offs against ISO 25010 quality attributes, and detects anti-patterns.
