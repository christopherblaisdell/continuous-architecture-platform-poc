# Deep Research Brownfield Adoption

Deep research prompt for OpenSpec brownfield adoption — covers discovery methodology, instruction consolidation patterns, and migration strategy for workspaces with existing AI instruction files.
